...
public BoardUpdate(String board_title, String board_content,int board_id,String uploadType,String imageFilePathA,String imageUploadPathA) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
          ...
          /*  Uri.Builder builder1 = new Uri.Builder();
            ...
            String postURL = ipConfig + "/index/board_update";
