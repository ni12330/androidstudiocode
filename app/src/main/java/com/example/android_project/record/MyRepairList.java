...
import com.example.android_project.recode_input.RepairDTO;
...
public class MyRepairList extends AsyncTask<Void, Void, Void> {
    ...
    public MyRepairList(ArrayList<RecordDTO> arrayList, MyRepairAdapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/index/myRepairList" + builder1;
    ...
    public RecordDTO readMessage(JsonReader reader) throws IOException {
        ...
        String repair_name = "", repair_cost = "", memo = "", car_mileage = "", repair_term = "", record_date = "", record_id="";

        reader.beginObject();
        while (reader.hasNext()) {
            String readStr = reader.nextName();
            if (readStr.equals("repair_name")) {
                repair_name = reader.nextString();
            } else if (readStr.equals("repair_cost")) {
                repair_cost = reader.nextString();
        ...
        return new RecordDTO(repair_name, repair_cost, memo, car_mileage, repair_term, record_date,record_id);
    }
